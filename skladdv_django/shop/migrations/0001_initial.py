# Generated by Django 3.2.3 on 2022-04-18 11:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('создан', 'создан'), ('заказан', 'заказан'), ('собран', 'собран'), ('исполнен', 'исполнен'), ('отменен', 'отменен')], default='создан', max_length=20, verbose_name='статус')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inn', models.CharField(max_length=200, null=True, validators=[django.core.validators.RegexValidator(message='Значение в поле "ИНН" должно состоять из 10 цифр от 0 до 9', regex='^\\d{10}$')], verbose_name='ИНН')),
                ('ogrn', models.CharField(max_length=200, null=True, validators=[django.core.validators.RegexValidator(message='Значение в поле "ОГРН" должно состоять из 13 цифр от 0 до 9', regex='^\\d{13}$')], verbose_name='ОГРН')),
                ('address', models.CharField(max_length=200, verbose_name='адрес')),
                ('contact_person', models.CharField(max_length=200, verbose_name='контактное лицо')),
                ('telephone', models.CharField(max_length=200, validators=[django.core.validators.RegexValidator(message='Значение в поле "Телефон" должно состоять из 11 цифр от 0 до 9,где первая цифра - 7', regex='^7\\d{10}$')], verbose_name='телефон')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('time_create', models.DateTimeField(auto_now_add=True, verbose_name='время создания')),
                ('status', models.CharField(choices=[('заказана', 'заказана'), ('отменена', 'отменена'), ('поступила на склад', 'поступила на склад')], default='заказана', max_length=20, verbose_name='статус')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('создание поставщика', 'создание поставщика'), ('создание покупателя', 'создание покупателя'), ('создание товара', 'создание товара')], max_length=20, verbose_name='тип')),
                ('created_by', models.PositiveIntegerField(verbose_name='создано пользователем(id)')),
                ('time_create', models.DateTimeField(auto_now_add=True, verbose_name='время создания')),
                ...
                ('good', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='shop.good', verbose_name='товар')),
                ('supplier', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='shop.supplier', verbose_name='поставщик')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('telephone', models.CharField(max_length=50, null=True, validators=[django.core.validators.RegexValidator(message='Значение в поле "Телефон" должно состоять из 11 цифр от 0 до 9,где первая цифра - 7', regex='^7\\d{10}$')], verbose_name='телефон')),
